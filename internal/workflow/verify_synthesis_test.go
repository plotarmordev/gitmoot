...
func seedVerifyCoordinator(t *testing.T, store *db.Store, payload JobPayload) {
	t.Helper()
	payload.Repo = "plotarmordev/gitmoot"
...
func TestEngineVerifySynthesisPassesEnqueuesNormalContinuation(t *testing.T) {
	...
	seedAgent(t, store, "producer", []string{"implement"}, "plotarmordev/gitmoot")
	seedAgent(t, store, "verifier", []string{"review"}, "plotarmordev/gitmoot")
